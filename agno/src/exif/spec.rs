...
exif_tags![
    (GPS_LATITUDE_REF, 0x0001, IFD0, "GPSLatitudeRef"),
    (GPS_LATITUDE, 0x0002, IFD0, "GPSLatitude"),
    (GPS_LONGITUDE_REF, 0x0003, IFD0, "GPSLongitudeRef"),
    (GPS_LONGITUDE, 0x0004, IFD0, "GPSLongitude"),
    (GPS_ALTITUDE_REF, 0x0005, IFD0, "GPSAltitudeRef"),
    (GPS_ALTITUDE, 0x0006, IFD0, "GPSAltitude"),
    (GPS_TIME_STAMP, 0x0007, IFD0, "GPSTimeStamp"),
    (GPS_SATELLITES, 0x0008, IFD0, "GPSSatellites"),
    (GPS_STATUS, 0x0009, IFD0, "GPSStatus"),
    (GPS_MEASURE_MODE, 0x000a, IFD0, "GPSMeasureMode"),
    // GPS_DOP (0x000b) omitted — conflicts with PROCESSING_SOFTWARE in IFD0 namespace
    (GPS_SPEED_REF, 0x000c, IFD0, "GPSSpeedRef"),
    (GPS_SPEED, 0x000d, IFD0, "GPSSpeed"),
    (GPS_TRACK_REF, 0x000e, IFD0, "GPSTrackRef"),
    (GPS_TRACK, 0x000f, IFD0, "GPSTrack"),
    (GPS_IMG_DIRECTION_REF, 0x0010, IFD0, "GPSImgDirectionRef"),
    (GPS_IMG_DIRECTION, 0x0011, IFD0, "GPSImgDirection"),
    (GPS_MAP_DATUM, 0x0012, IFD0, "GPSMapDatum"),
    (GPS_DEST_LATITUDE_REF, 0x0013, IFD0, "GPSDestLatitudeRef"),
    (GPS_DEST_LATITUDE, 0x0014, IFD0, "GPSDestLatitude"),
    (GPS_DEST_LONGITUDE_REF, 0x0015, IFD0, "GPSDestLongitudeRef"),
    (GPS_DEST_LONGITUDE, 0x0016, IFD0, "GPSDestLongitude"),
    (GPS_DEST_BEARING_REF, 0x0017, IFD0, "GPSDestBearingRef"),
    (GPS_DEST_BEARING, 0x0018, IFD0, "GPSDestBearing"),
    (GPS_DEST_DISTANCE_REF, 0x0019, IFD0, "GPSDestDistanceRef"),
    (GPS_DEST_DISTANCE, 0x001a, IFD0, "GPSDestDistance"),
    (GPS_PROCESSING_METHOD, 0x001b, IFD0, "GPSProcessingMethod"),
